...
# Description:
# This script is the function summary of HSI calculation
...
def get_ts(tw, rh):
    ...
    rh = rh / 100  # change RH from 0-100% to 0-1
    ts = tw + 4.5 * (1 - rh ** 2)
...
def get_utci(tdb, tr, v, rh, pres):
    # unit: Celsius degree, Celsius degree, m/s, RH%, Pa
